...
`toxic`, `coin`, `background`, `platform`; `ellis` (Commander Ellis at HQ); `turret` (allied Mold Turret that auto-fires at enemies); `molde` (MOLD-E companion drone that trails Ty).
