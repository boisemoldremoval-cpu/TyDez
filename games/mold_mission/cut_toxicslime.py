#!/usr/bin/env python3
"""Cut the Toxic Slime enemy sprites from its magenta chroma sheet into assets/.
...
SHEET = "art_reference/pending/toxic_slime_sheet.png"
OUT = "assets"

# name -> region box (l, t, r, b) around a single blob, clear of neighbours/text.
REGIONS = {
    "toxicslime":         (352, 110, 486, 224),   # IDLE (row 1, frame 1)
    "toxicslime_run":     (645, 118, 772, 214),   # SLOW CRAWL (frame 1)
    "toxicslime_attack":  (300, 388, 412, 480),   # ACID SPIT (body; engine spits)
    "toxicslime_hurt":    (300, 548, 428, 636),   # HURT
    "toxicslime_enraged": (300, 706, 442, 802),   # ENRAGED (rare, low-HP state)
}
