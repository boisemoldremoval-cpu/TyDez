#!/usr/bin/env python3
"""Cut the Mold Crawler enemy sprites from its magenta chroma sheet into assets/
(this replaces the old vector Mold Crawler with real art). Largest-connected-blob
...
SHEET = "art_reference/pending/mold_crawler_sheet.png"
OUT = "assets"
...
REGIONS = {
    ...
    "moldcrawler_enraged": (532, 716, 702, 804),   # INFECTED (rage mode)
}
